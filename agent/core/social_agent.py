...
time_to_update_group_trace = int(os.getenv("SA_TIME_TO_UPDATE_GROUP_TRACE"))
time_to_write_log = int(os.getenv("SA_TIME_TO_WRITE_LOG"))

ontology = Ontology("file://web/onto/social-model.owl")
